...
import com.ioter.hopeland.uhf.UHF1.UHF1Application;
import com.ioter.hopeland.uhf.UHF1Function.AndroidWakeLock;
import com.ioter.hopeland.uhf.UHF1Function.SPconfig;
import com.ioter.hopeland.uhf.UHF5.RFIDOperate;
import com.ioter.hopeland.uhf.UHF5helper.InventoryBuffer;
import com.ioter.hopeland.uhf.UHF5helper.ReaderHelper;
import com.ioter.hopeland.uhf.UHF6.UHF006;
...
import static com.ioter.hopeland.Comm.DeviceType.supion_M_3;
import static com.ioter.hopeland.Comm.DeviceType.supion_M_4;
import static com.ioter.hopeland.Comm.DeviceType.supion_S_3;
import static com.ioter.hopeland.Comm.DeviceType.supion_S_4;
import static com.ioter.hopeland.Comm.DeviceType.supion_Y_4;
import static com.ioter.hopeland.Comm.Module.UHF005;
import static com.ioter.hopeland.Comm.operateType.lockOpe;
import static com.ioter.hopeland.Comm.operateType.readOpe;
import static com.ioter.hopeland.Comm.operateType.setPower;
import static com.ioter.hopeland.Comm.operateType.writeOpe;
import static com.ioter.hopeland.uhf.UHF1.UHF001.Devaddrs;
import static com.ioter.hopeland.uhf.UHF1.UHF001.er;
import static com.ioter.hopeland.uhf.UHF1.UHF001.getAntPowerConf;
import static com.ioter.hopeland.uhf.UHF1.UHF001.getGen2Session;
import static com.ioter.hopeland.uhf.UHF1.UHF001.getRegion_Conf;
import static com.ioter.hopeland.uhf.UHF1.UHF001.getgen2q;
import static com.ioter.hopeland.uhf.UHF1.UHF001.setAntCheck;
import static com.ioter.hopeland.uhf.UHF1.UHF001.setAntPowerConf;
import static com.ioter.hopeland.uhf.UHF1.UHF001.setReg;
import static com.ioter.hopeland.uhf.UHF1.UHF001.setRegion_Conf;
import static com.ioter.hopeland.uhf.UHF1.UHF001.setUHF1Parameters;
import static com.ioter.hopeland.uhf.UHF1.UHF001.uhf1lockOp;
import static com.ioter.hopeland.uhf.UHF1.UHF001.uhf1readOp;
import static com.ioter.hopeland.uhf.UHF5.RFIDOperate.mReader;
import static com.ioter.hopeland.uhf.UHF5.RFIDOperate.m_curInventoryBuffer;
import static com.ioter.hopeland.uhf.UHF5.RFIDOperate.m_curReaderSetting;
import static com.ioter.hopeland.uhf.UHF5.RFIDOperate.setUHF5Parameters;
import static com.ioter.hopeland.uhf.UHF5.RFIDOperate.uhf5lockOp;
import static com.ioter.hopeland.uhf.UHF5.RFIDOperate.uhf5readOp;
import static com.ioter.hopeland.uhf.UHF5.RFIDOperate.uhf5writeOp;
